...
module internal PostEmails =
  
  let verifyEmail (uri: System.Uri) name = "Verify your email address", $$"""
<!DOCTYPE html>
...
<body style="margin: 0; width: 100%; background-color: #f8fafc; padding: 0; -webkit-font-smoothing: antialiased; word-break: break-word">
  ...
  <div role="article" aria-roledescription="email" aria-label lang="en">
    <div class="sm-px-4" style="background-color: #fafafa; font-family: Inter, ui-sans-serif, system-ui, -apple-system, 'Segoe UI', sans-serif">
              ...
              <tr>
                <td class="sm-p-6" style="border-radius: 8px; background-color: #fffffe; padding: 24px 36px; border: 1px solid #e2e8f0">
                  ...
                  <p style="margin: 0 0 24px; font-size: 16px; line-height: 24px; color: #475569">
                    Thanks for your comment! In order to proceed with posting it, please verify your email address:
                  </p>
                  <div>
                    <a href="{{uri}}" style="display: inline-block; text-decoration: none; padding: 16px 24px; font-size: 16px; line-height: 1; border-radius: 4px; color: #fffffe; background-color: #020617" class="hover-bg-slate-800">
                  ...
                  <p style="margin: 0; font-size: 16px; line-height: 24px; color: #475569">
                    Thanks,
                    <br>
                    <span style="font-weight: 600">Matt</span>
                  </p>
                  ...
                  <p class="mso-break-all" style="margin: 0; font-size: 12px; line-height: 20px; color: #475569">
                    ...
                    your web browser:
                    <a href="{{uri}}" style="color: #1e293b; text-decoration: underline">{{uri}}</a>
                  </p>
                </td>
              </tr>
            </table>
              ...
              <tr>
                <td class="sm-px-6" style="padding: 24px 36px">
                  <p style="margin: 0; font-size: 12px; color: #64748b">
                    &copy; 2025 TwoPoint. All rights reserved.
                  </p>
                </td>
              </tr>
            </table>
