...
Do I accept responsibility for keeping an accurate mental model? Yes.
...
Here's `TryFirst()`, implemented specifically to deal with value types. Let's call it `TryFirstValue()`:
...
Applying this change to all our variants, our `DateTime` examples actually produce the expected output. I highly encourage you to <a href="https://dotnetfiddle.net/ixdNkO
