...
excerpt: Build a reminders app completely in F#. In part 1, we get our base project setup, as well as scaffolding out the structure of the UI.
category: Series
series:
...
The JavaScript side is what will eventually be loaded up and run by the browser
...
Pretty cool. It will be cooler when we writw our _entire app_ in F#! Speaking of our app, here's our end goal:
...
In part 2, we'll take a first pass at our implementation, and we'll get our first look at using Feliz and Elmish in the process!
